...
exports.seed = async function (knex) {
  ...
  await knex("events").insert([
    ...
    },
    {
      ...
      cover_photo: "http://localhost:8080/event-images/kidsparty.svg",
      details:
    ...
    },
    {
      ...
      cover_photo: "http://localhost:8080/event-images/musicfest.svg",
      details:
    ...
    },
    {
      ...
      cover_photo: "http://localhost:8080/event-images/jazz.jpeg",
      details:
    ...
    },
    {
      ...
      cover_photo: "http://localhost:8080/event-images/beachparty.jpg",
      details:
    ...
    },
    {
      ...
      cover_photo: "http://localhost:8080/event-images/masquerade_ball.jpg",
      details:
